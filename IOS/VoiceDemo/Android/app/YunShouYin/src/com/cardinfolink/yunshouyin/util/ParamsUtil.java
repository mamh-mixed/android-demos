...
import com.cardinfolink.cashiersdk.util.EncoderUtil;
...
public class ParamsUtil {
	...
	@SuppressLint("SimpleDateFormat") public static RequestParam getLogin(String username,String password){
	...
	@SuppressLint("SimpleDateFormat") public static RequestParam getRequestActivate(String username,String password){
		RequestParam requestParam=new RequestParam();
	...
	public static RequestParam getHistory(User user,String month,long index){
		RequestParam requestParam=new RequestParam();
	...
	@SuppressLint("SimpleDateFormat") public static RequestParam getUpdate(String username,String oldpassword,String newpassword){
		RequestParam requestParam=new RequestParam();
	...
	@SuppressLint("SimpleDateFormat") public static RequestParam getReset(String username,String code,String newpassword){
		RequestParam requestParam=new RequestParam();
