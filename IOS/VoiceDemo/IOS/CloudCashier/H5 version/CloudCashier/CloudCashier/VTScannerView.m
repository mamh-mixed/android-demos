...
////    backBtn.frame = CGRectMake(width/10, 70, width/8, width/8);
////    [backBtn setBackgroundImage:[UIImage imageNamed:@"return.png"] forState:UIControlStateNormal];
////    [self addSubview:backBtn];
//
//    _vtMenuView = [[VTMenuView alloc] initWithFrame:CGRectMake(0, viewHeight+100, width/2, viewHeight-100)];
//    _vtMenuView.backgroundColor = [UIColor whiteColor];
//    [self addSubview:_vtMenuView];
