...
gulp.task('jshint', function() {
  return gulp.src([
      ...
      '!app/elements/file-upload/file-upload.html'
    ])
    .pipe(reload({
      stream: true,
      once: true
...
gulp.task('dev:dist', ['styles', 'elements', 'images', 'dev-copy'], function() {
  browserSync({
    notify: false,
    logPrefix: 'PSK',
    snippetOptions: {
  ...
  gulp.watch(['app/**/*.html'], ['dev-copy', reload]);
  gulp.watch(['app/styles/**/*.css'], ['styles', reload]);
  gulp.watch(['app/elements/**/*.css'], ['elements', reload]);
  gulp.watch(['app/{scripts,elements}/**/*.js'], ['dev-copy', reload]);
