 ...
 * 自定义的组合控件
 */
public class SettingActionBarView extends RelativeLayout {
    private TextView mLeftText;
    private TextView mTitle;
    private TextView mRightText;


    public SettingActionBarView(Context context) {
        super(context);
        initView(context);
    }

    public SettingActionBarView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    ...
    public SettingActionBarView(Context context, AttributeSet attrs, int defStyle) {
