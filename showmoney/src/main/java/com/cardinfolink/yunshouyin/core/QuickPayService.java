...
public interface QuickPayService {
    ...
    //user logged in
    void updateInfoAsync(String province, String city, String bank_open, String branch_bank, String bankNo, String payee, String payee_card, String phone_num, QuickPayCallbackListener<Void> listener);

    void increaseLimitAsync(String payee, String phone_num, String email, QuickPayCallbackListener<Void> listener);

    void getBankInfoAsync(QuickPayCallbackListener<BankInfo> listener);
