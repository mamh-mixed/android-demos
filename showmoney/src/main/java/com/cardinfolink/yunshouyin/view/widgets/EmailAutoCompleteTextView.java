package com.cardinfolink.yunshouyin.view.widgets;
...
public class EmailAutoCompleteTextView extends AutoCompleteTextView {
    ...
    private void init(final Context context) {
        ...
        this.setAdapter(new EmailAutoCompleteAdapter(context, R.layout.auto_amail_item, emailSufixs));
        //使得在输入1个字符之后便开启自动完成  
        this.setThreshold(1);
