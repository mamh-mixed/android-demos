...
type PrecreateReq struct {
	...
	GoodsDetail          interface{} `json:"goods_detail,omitempty"`          // 商品明细列表，Json 格式，其它说明详见:“商品明细说明” [{"goods_id": "apple-01","goods_name":"ipad","goods_category":"7788230","price":" 2000.00","quantity":"1"}]
	...
	ExtendParams         interface{} `json:"extend_params,omitempty"`         // 扩展参数
