...
public class SecondActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        allAppInfoList = ((ArrayList<AppInfo>) getIntent()
                .getSerializableExtra("allAppInfoList"));
        ...
        for (int i = 0; i < allAppInfoList.size(); i++) {
            ...
            if (contains(appinfo, secondcheckedAppInfoList)) {
                cb.setChecked(true);
            } else {
                cb.setChecked(false);
            }
            if (contains(appinfo, firstcheckedAppInfoList)
                    || contains(appinfo, thirdcheckedAppInfoList)) {
                cb.setEnabled(false);
            }
            cb.setId(i);
        ...
        confirmButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                intent.putExtra("secondcheckedAppInfoList", checkedAppInfoList);
                setResult(SECOND_RESULT, intent);
                finish();
            }
