...
public class FirstActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < allAppInfoList.size(); i++) {
            ...
            if (contains(appinfo, secondcheckedAppInfoList) || contains(appinfo, thirdcheckedAppInfoList)) {
                cb.setEnabled(false);
            }
        ...
        confirmButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                intent.putExtra("firstcheckedAppInfoList", checkedAppInfoList);
                setResult(FIRST_RESULT, intent);
                finish();
            }
