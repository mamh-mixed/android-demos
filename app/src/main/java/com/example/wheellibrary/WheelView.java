...
public class WheelView extends View {
     ...
     */
    private static final int MIN_DELTA_FOR_SCROLLING = 100000;
     ...
     */
    private static final int ADDITIONAL_ITEMS_SPACE = 30;
    ...
    public void setAdapter(WheelAdapter adapter) {
        ...
        if (adapter != null) {
            minPos = 0;
            maxPos = adapter.getItemsCount() - 1;
        } else {
        }
        invalidateLayouts();
        invalidate();
    ...
    /**
     * verify current position of item.
     *
     * @param pos current item index
     * @return true if valid pos
     */
    private boolean isValidPosition(int pos) {
        return (pos <= maxPos) && (pos >= minPos);
    }

    /**
     * update current range of item.
     *
     * @param min : min index of item
     * @param max : max index of item
     */
    public void updateItemRange(int min, int max) {
        minPos = min;
        maxPos = max;
    }

    /**
     * get current max range of item.
     *
     * @return max index of item
     */
    public int getMaxItemRange() {
        return maxPos;
    }

    /**
     * get current min range of item.
     *
     * @return min index of item
     */
    public int getMinItemRange() {
        return minPos;
    }
    ...
    private Handler animationHandler = new Handler() {
        public void handleMessage(Message msg) {
            ...
            // scrolling is not finished
            // when it comes to final Y
